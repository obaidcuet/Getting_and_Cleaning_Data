...
This column will have any of the below values:
 ...
 [2] "subject"    
Data Type: integer 
Values of this column are refering to the subject(person) on which the original experiment conducted.
This column will have any integer value between 1 to 30 
